...
## ![Sign Language Icon](https://img.icons8.com/color/48/000000/american-sign-language-interpreting.png) [Real-Time Sign Language Translation Dissertation Project](https://github.com/Srihaas007/BSL-ISL-Transfer-learning)
Conducted research on real-time sign language translation, utilizing transfer learning to train a model for ISL (Indian Sign Language) using BSL (British Sign Language) as a base. Obtained datasets and model credentials from Oxford and BBC, aiming for a 90% accuracy rate. Explored real-time application and future integration with wearable technology.


It looks like you want to include a new icon for your dissertation project and make sure it displays correctly. Here’s a revised version of your text with a new icon:

## ![Sign Language Icon](https://img.icons8.com/ios-filled/50/000000/american-sign-language-interpreting.png) [Real-Time Sign Language Translation Dissertation Project](https://github.com/Srihaas007/BSL-ISL-Transfer-learning)
Conducted research on real-time sign language translation, utilizing transfer learning to train a model for ISL (Indian Sign Language) using BSL (British Sign Language) as a base. Obtained datasets and model credentials from Oxford and BBC, aiming for a 90% accuracy rate. Explored real-time application and future integration with wearable technology.

Feel free to adjust the link or icon if needed!
